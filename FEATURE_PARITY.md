...
- Local audio format diagnostics for WAV, FLAC, AIFF/AIFC, and DSD containers, showing source sample rate, bit depth, channel count, and codec when available; hardware-exclusive/DAC-lock status is not inferred
