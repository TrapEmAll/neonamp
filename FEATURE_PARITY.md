...
- Bit-perfect best-effort local playback mode that bypasses NeonAmp EQ, loudness normalization, convolution, software limiting, playback-rate transforms, and crossfade for natively supported formats; WASAPI/AudioTrack exclusive hardware output is not guaranteed by the current Flutter backends
