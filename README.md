...
- Jump backward or forward by 15 seconds from the player controls on Windows and Android.
- Customize, reorder, add, and remove player-bar controls; layouts persist across launches.
